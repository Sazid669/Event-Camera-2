"""
Multi-focal normalized gradient magnitude.
...
class MultifocalNormalizedGradientMagnitude(LossBase):
    """
    Multi-focal normalized gradient magnitude loss function.
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Initialize normalized gradient magnitude loss
        self._normalized_gradient_magnitude = NormalizedGradientMagnitude(
            direction=direction,
            store_history=store_history,
            precision=precision,
            use_cuda=use_cuda
    ...
    def calculate(self, args: Dict) -> torch.Tensor:
        ...
        loss_start = self._normalized_gradient_magnitude.calculate(
            args={
                "ie": ie,
                "iwe": start_iwe,
        ...
        loss_middle = self._normalized_gradient_magnitude.calculate(
            args={
                "ie": ie,
                "iwe": middle_iwe,
                "omit_boundary": omit_boundary
        ...
        loss_end = self._normalized_gradient_magnitude.calculate(
            args={
                "ie": ie,
                "iwe": end_iwe,
                "omit_boundary": omit_boundary
